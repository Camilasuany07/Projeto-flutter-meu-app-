...
import 'package:flutter_gymapp_teste/modelos/sentimento_modelo.dart';
...
class ExercicioTela extends StatelessWidget {
  ...
  final List<SentimentoModelo> listaSentimentos = [
    SentimentoModelo(
        id: "SE001", sentindo: "Pouco esforço hoje", data: "02-07-2024"),
    SentimentoModelo(
      id: "SE001",
      sentindo: "Já percebo alguma diferença no aprendizado",
      data: "2024-07-19",
    ),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: MinhasCores.violetaClaro,
        elevation: 0,
        toolbarHeight: 72,
